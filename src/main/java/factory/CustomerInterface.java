...
public class CustomerInterface extends MouseAdapter implements ActionListener {
    ...
    private void createMessageArea() {
        this.messageArea = new JTextArea("Hello World");
    ...
    private void createDashBoard() {
        ...
        logo = new JLabel(scaleImage("logo.png", 100, 100));
    ...
    private void createSearchResultPanel() {
        ...
        search_result_panel.add(new JLabel(scaleImage("mic.jpeg", 600, 450)));
    }
    ...
    private void configureInterface() {
        ...
        textField = createTextField("Hello World fs", dim[0], 0, 0);
